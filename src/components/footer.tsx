    ...
    <footer className="bg-slate-900 text-slate-400 mt-10">
        ...
        <div className="space-y-3">
          ...
          >
            <span className="group-hover:underline underline-offset-2">
              Call blocking in cloud systems supporting multirate random traffic
              &ndash; The case of the Infrastructure as a Service model (IaaS)
            </span>
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-6 py-4 text-center text-xs text-slate-500 leading-relaxed">
          The content on this site is based on personal handwritten study notes
          and may contain errors or omissions. If you spot a mistake, please{" "}
          <a
      ...
      <div className="border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs">
          <span className="text-slate-300">
            &copy; {new Date().getFullYear()} Maria Kourtesi. Licensed under{" "}
            <a
