          ...
          <footer className="bg-slate-900 text-slate-400 mt-10">
            <div className="max-w-4xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm leading-relaxed">
                  An interactive reference for teletraffic loss models, built as
                  a companion to academic study.
                </p>
                <div className="pt-1">
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="group-hover:underline underline-offset-2">
                    ...
                    traffic &ndash; The case of the Infrastructure as a Service
                    model (IaaS)
                  </span>
                  ...
                  <li className="flex gap-3">
                    ...
                    <p className="text-sm leading-relaxed">
                      <span className="text-slate-400">
                        ...
                        , I-A. Chousainov, I. Keramidi, D. Uzunidis, O. Zestas,
                        I. D. Moscholios and M. Logothetis.{" "}
                      </span>
                      <span className="text-slate-300 italic">
                        &ldquo;On the limited-availability group model for
                        multirate Poisson traffic.&rdquo;
                      </span>
                      <span className="text-slate-500">
                        {" "}
                        Proc. Panhellenic Conf. Electronics and
                        Telecommunications (PACET).
                      </span>
                    </p>
                  </li>
                </ul>
            ...
            <div className="border-t border-slate-800">
              <div className="max-w-4xl mx-auto px-6 py-4 text-center text-xs text-slate-500 leading-relaxed">
                ...
                notes and may contain errors or omissions. If you spot a
                mistake, please{" "}
                <a
            ...
            <div className="border-t border-slate-800">
              <div className="max-w-4xl mx-auto px-6 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs">
                <span className="text-slate-300">
                  &copy; {new Date().getFullYear()} Maria Kourtesi. Licensed
                  under{" "}
                  <a
