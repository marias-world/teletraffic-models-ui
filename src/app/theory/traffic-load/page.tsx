        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-md space-y-8">
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              It is the ratio of the total time lines were occupied to the length of the
              observation window.
            </p>
          ...
          <section className="space-y-4">
            ...
            <div className="overflow-x-auto rounded-xl border border-slate-200 bg-slate-50 p-4">
              <svg viewBox={`0 0 ${SVG_W} ${SVG_H}`} className="w-full" style={{ minWidth: 320 }}>
                ...
                {/* total period arrow */}
                <line
                  x1={toX(0)} y1={SVG_H - 22}
                  x2={toX(30)} y2={SVG_H - 22}
                  stroke="#94a3b8" strokeWidth={1}
                  markerEnd="url(#arrow)" markerStart="url(#arrowL)"
                />
                <defs>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-700">Step-by-step calculation</h2>
            ...
            <div className="bg-slate-50 rounded-xl border border-slate-200 p-5 space-y-4">
              ...
              <div className="bg-sky-50 border border-sky-200 rounded-lg p-4">
                <p className="text-slate-700">
                  This means that on average, about <strong>2 out of 4 lines</strong> were
                  busy at any point during those 30 minutes.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* The formula */}
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-slate-700">The general formula</h2>
            <p className="text-slate-600">
              Instead of adding individual call durations, you can express traffic load
              using two summary numbers:
            </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 space-y-2">
              <p className="text-slate-700 font-medium">Applied to the example:</p>
              <BlockMath math="\alpha = \frac{10 \times 6.2}{30} = \frac{62}{30} \approx 2.07 \text{ Erl}" />
              <p className="text-slate-600 text-sm">
                (<InlineMath math="h = 62 / 10 = 6.2" /> min average call duration)
              </p>
            </div>
          </section>
          ...
          {/* Unit: Erlang */}
          <section className="space-y-3">
            <h2 className="text-xl font-semibold text-slate-700">The unit: Erlang</h2>
            <p className="text-slate-600 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 text-center text-sm">
              {[
                ...
                <div key={value} className="bg-slate-50 border border-slate-200 rounded-xl p-3">
          ...
          <section className="space-y-3">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              <InlineMath math="C" />, Erlang-B tells you the probability that an
              incoming call finds all lines busy and gets blocked.
            </p>
            <Link
              href="/erlang"
