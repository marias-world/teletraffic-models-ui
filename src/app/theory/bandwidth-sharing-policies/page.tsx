      ...
      <div className="max-w-3xl mx-auto bg-white p-4 sm:p-8 rounded-xl shadow-md space-y-10">
        ...
        <div className="bg-sky-50 border border-sky-200 rounded-xl p-5 space-y-3">
          ...
          <p className="text-slate-700 leading-relaxed">
            A <strong>service class</strong> is a group of calls that all share
            the same characteristics, most importantly they each require the
            same number of <strong>bandwidth units (b.u.s)</strong> from the
            system.
          </p>
          <p className="text-slate-700 leading-relaxed">
          ...
          <p className="text-slate-600 text-sm">
            A <strong>bandwidth sharing policy</strong> determines the rules by
            which these classes compete for the available capacity: which calls
            are accepted, which are blocked, and whether any bandwidth is
            reserved or guaranteed per class.
          </p>
        </div>
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            experienced by each class and the overall utilisation of the system.
          </p>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            does not exceed <em>C</em>. No bandwidth is reserved or ring-fenced
            for any class.
          </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            service class. A call of class <em>i</em> can only be served within
            its own allocated partition{" "}
            <em>
              C<sub>i</sub>
            </em>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-1">
              ...
              <p className="text-sm text-slate-600">
                ...
                be starved by other classes because its partition is exclusively
                reserved.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-1">
              ...
              <p className="text-sm text-slate-600">
                Fixed partitions cannot adapt to changing traffic patterns. Idle
                capacity in one partition cannot be used by another class,
                leading to waste and inefficiency in a multi-service
                environment.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-1">
              ...
              <p className="text-sm text-slate-600">
                Provides a bandwidth guarantee per class (via thresholds) while
                allowing unrestricted sharing up to each threshold, combining
                the best properties of CS and CP.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-1">
              <p className="text-sm font-semibold text-red-600">Limitation</p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            b.u. is reserved by the system so that service class <em>k</em> sees{" "}
            <em>
              C &minus; t<sub>k</sub>
            </em>{" "}
            b.u. as its effective system capacity. A call of class <em>k</em> is
            accepted only if the currently occupied bandwidth does not exceed{" "}
            <em>
              C &minus; t<sub>k</sub>
            </em>{" "}
            b.u.
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 space-y-3">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              ...
              capacity remains for each service class. However, they are usually
              chosen so that the sum of the bandwidth requirement and the
              reservation is equal across all service classes:
            </p>
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              When this condition holds, each service class experiences the same
              effective load relative to its capacity, which leads directly to
              GoS equalisation.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-1">
              ...
              <p className="text-sm text-slate-600">
                ...
                Achieves fair GoS across all service classes when parameters are
                set correctly.
              </p>
            </div>
            <div className="bg-red-50 border border-red-200 rounded-xl p-4 space-y-1">
              ...
              <p className="text-sm text-slate-600">
                ...
                must be carefully engineered per class. Poor choices can reduce
                overall utilisation or fail to achieve GoS equalisation.
              </p>
            </div>
          </div>
        </section>
