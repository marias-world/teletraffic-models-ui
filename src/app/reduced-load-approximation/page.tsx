          ...
          <section className="space-y-4">
            ...
            <div className="flex gap-3 bg-violet-50 border border-violet-200 rounded-xl p-4">
              ...
              <p className="text-sm text-violet-900 leading-relaxed">
                In the Reduced Load Approximation, a call that is already
                blocked on one link never reaches the next link, so it does not
                add load there. The model lowers (reduces) the traffic each link
                sees to account for this. Since every link&apos;s load depends
                on the others, the calculation is repeated until the numbers
                stop changing.
              </p>
            </div>
          </section>
